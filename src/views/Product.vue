            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="product-pic-zoom">
                  <img class="product-big-img" :src="pic" alt="" />
                </div>
                <div class="product-thumbs">
                  ...
                  >
                    ...
                    <div
                      ...
                      :class="thumbs[3] == pic ? 'active' : ''"
                    >
                      <img src="img/jaket4.jpg" alt="" />
                    </div>
                  </carousel>
                </div>
              </div>
